...
from pnmt.utils.distributed import ErrorHandler, consumer, batch_producer
from pnmt.utils.misc import set_random_seed
from pnmt.modules.embeddings import prepare_pretrained_embeddings
from pnmt.utils.logging import init_logger, logger

from pnmt.models.model_saver import load_checkpoint
from pnmt.train_single import main as single_main, _build_train_iter

from pnmt.utils.parse import ArgumentParser
from pnmt.opts import train_opts
from pnmt.inputters.corpus import save_transformed_sample
from pnmt.inputters.fields import build_dynamic_fields, save_fields, \
    load_fields
from pnmt.transforms import make_transforms, save_transforms, \
...
def prepare_fields_transforms(opt):
    ...
    specials = get_specials(opt, transforms_cls)# get special vocabs for the src and tgt vocab
