...
import pnmt.opts
from pnmt.model_builder import build_embeddings, \
    build_encoder, build_decoder
from pnmt.utils.parse import ArgumentParser

parser = ArgumentParser(description='train.py')
pnmt.opts.model_opts(parser)
pnmt.opts._add_train_general_opts(parser)
...
class TestModel(unittest.TestCase):
    ...
    def get_field(self):
        src = pnmt.inputters.get_fields("text", 0, 0)["src"]
    ...
    def nmtmodel_forward(self, opt, source_l=3, bsize=1):
        ...
        model = pnmt.models.model.NMTModel(enc, dec)
...
if pnmt.models.sru.check_sru_requirement():
