...
import pnmt.model_builder
import pnmt.inputters as inputters
import pnmt.decoders.ensemble
from pnmt.inputters.text_dataset import InferenceDataIterator
from pnmt.translate.beam_search import BeamSearch, BeamSearchLM
from pnmt.translate.greedy_search import GreedySearch, GreedySearchLM
from pnmt.utils.misc import tile, set_random_seed, report_matrix
...
def build_translator(opt, report_score=True, logger=None, out_file=None):
    ...
    load_test_model = (
        pnmt.decoders.ensemble.load_test_model
        if len(opt.models) > 1
