...
from pnmt.utils.misc import check_model_config
from pnmt.utils.alignment import to_word_align
from pnmt.utils.parse import ArgumentParser
from pnmt.translate.translator import build_translator
from pnmt.transforms.features import InferFeatsTransform
...
class ServerModel(object):
    ...
    def parse_opt(self, opt):
       ...
       Returns:
        ...
        pnmt.opts.translate_opts(parser)
